            ...
            {userDB === null &&
                <div className={style.containerTwo}>
                    ...
                    <div className={style.avatarsContainer}>
                        <img src="/ab1.png" alt="avatar" className={`${style.avatarb1} ${avatar == 'ab1' ? style.filter: ''}`} onClick={(e)=>{avatarClick('ab1')}}/>
                        <img src="/ab2.png" alt="avatar" className={`${style.avatarb2} ${avatar == 'ab2' ? style.filter: ''}`} onClick={(e)=>{avatarClick('ab2')}}/>
                        <img src="/ag3.png" alt="avatar" className={`${style.avatar} ${avatar == 'ag3' ? style.filter: ''}`} onClick={(e)=>{avatarClick('ag3')}}/>
                        <img src="/ag2.png" alt="avatar" className={`${style.avatar} ${avatar == 'ag2' ? style.filter: ''}`} onClick={(e)=>{avatarClick('ag2')}}/>
                    </div> 
